...
def _ai_vision_validate_banner(
    ...
    prompt = (
        ...
        f'  List every NON-product object: laptops, plants, monitors, '
        f'  headphones, backpacks, keyboards, books, cups, etc. If those '
        f'  objects are not part of the named product, set check2 to '
        f'  "fail: <list>". Banner-template elements (orange glow, bezier '
        f'  curves, headline, price, pills) are NOT clutter.\n\n'
